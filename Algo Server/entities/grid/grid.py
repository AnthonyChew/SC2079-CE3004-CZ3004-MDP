...
class Grid:
    ...
    def draw_arena_borders(cls, screen):
        ...
        for j in range(settings.GRID_LENGTH//settings.GRID_CELL_LENGTH):
            font.render_to(screen, (settings.GRID_LENGTH + 10, settings.GRID_LENGTH - j* settings.GRID_CELL_LENGTH - 8), f"{abs(j-settings.GRID_LENGTH//settings.GRID_CELL_LENGTH + 1)}", pygame.Color('DarkBlue'))
